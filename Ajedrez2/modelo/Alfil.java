...
public class Alfil extends Ficha {
    ...
    public void draw(Graphics2D g, float x, float y) {
        ...
        g.fill(new Ellipse2D.Float(x + 20, y + 10, 8, 8));
        g.fill(new Rectangle2D.Float(x + 22, y + 17, 5, 27));
        g.fill(new Rectangle2D.Float(x + 14, y + 44,24, 5));
        g.setPaint(java.awt.Color.BLACK);
        g.draw(new Ellipse2D.Float(x + 20, y + 10, 8, 8));
        g.draw(new Rectangle2D.Float(x + 22, y + 17,5, 27));
        g.draw(new Rectangle2D.Float(x + 14, y + 44,24, 5));
    }
